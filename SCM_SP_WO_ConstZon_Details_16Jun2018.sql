...
--   SQLWOM.#WOM_SP_WO_ConstZon_Details '01-May-2018', '27-Aug-2018', 1, 523
--ALTER PROCEDURE SQLWOM.#WOM_SP_WO_ConstZon_Details
...
INSERT INTO #Temp_SCM_PO_Details
				...
				Temp_Planning_Inserted_On,Temp_WOR_WOA)
SELECT DISTINCT HWOA_WO_Number, HWOA_Amendment_Number,
	...
	FROM SQLWOM.WOM_H_WOA_Request, SQLWOM.WOM_D_WOA_Request 
	LEFT JOIN epm.SQLPMP.PMP_T_ExecPlan_Project_Work_Items 
	on dwoA_item_code= TEPWI_Work_Item_Code and DWOA_Markup_Code= TEPWI_MarkUp 
	and dWOA_Job_Code=TEPWI_Job_Code, 
		SQLWOM.WOM_H_Work_Orders, 
	...
	WHERE HWOA_WO_Number = DWOA_WO_Number AND DWOA_Amendment_Number = DWOAC_WO_Amendment_Number
				...
				--	AND MJITC_Company_Code = @intCompanyCode 
					...
					--and HWOA_WO_Number = 'EA200WOD8000024'
					and HWOA_Amendment_Number = DWOA_Amendment_Number
					
--select '#Temp_SCM_PO_Details' , * from #Temp_SCM_PO_Details 
...
SELECT Temp_WO_Number WO_Number, Temp_WO_Amendment_No Amendment_No,
 Temp_WO_Date WO_Date, 
						...
						Temp_Item_Version as Version,
						Temp_Item_Markup as Markup,
 ...
 where --Temp_WO_Basic_Rate <> Temp_Counter_Offer_Basic_Rate AND 
				...
				---and MIGRP_Description like '%project%'
